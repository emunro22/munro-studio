...
async function scanOneCompetitor(competitor) {
  ...
  await sql`
    INSERT INTO competitor_scans (
      ...
      has_faq_schema, has_llms_txt, sitemap_url_count, image_count, images_missing_alt,
      ...
      ${scan.hasOpenGraph}, ${scan.hasFaqSchema}, ${scan.hasLlmsTxt}, ${scan.sitemapUrlCount}, ${scan.imageCount},
...
export async function runCompetitorScan(client) {
  ...
  return { scanned: results.length, insightsInserted };
}
