...
export async function scanClient(client) {
  ...
  await sql`
    INSERT INTO site_scans (
      ...
      has_viewport_meta, has_schema_ld, image_count, images_missing_alt,
      ...
      ${scan.h1}, ${scan.wordCount}, ${scan.hasViewportMeta}, ${scan.hasSchemaLd}, ${scan.imageCount},
      ${scan.imagesMissingAlt}, ${scan.internalLinkCount}, ${scan.hasRobotsTxt}, ${scan.hasSitemap}, ${scan.error}
    )
  `;
