  ...
  if (priorAvg != null) {
    ...
    if (trendPct <= -10) {
      ...
      ideas.push({
        ...
        description: "Sustained growth over a month is a real signal — good time to consider raising this client's retainer scope or using it as a case study for new client pitches.",
      });
    }
  }
