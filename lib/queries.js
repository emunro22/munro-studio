...
export async function getClientDetail(slug) {
  ...
  const [metricsHistory, insights, scanHistory, reviewHistory, competitors] = await Promise.all([
  ...
  return { client, metricsHistory, insights, scanHistory, reviewHistory, competitors: competitorsWithScans };
}
