        ...
        <div className="max-w-7xl mx-auto px-6 md:px-10 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className="hidden sm:flex w-8 h-8 items-center justify-center text-ink/40 hover:text-ink transition-colors duration-200"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="hidden sm:flex w-8 h-8 items-center justify-center text-ink/40 hover:text-green-500 transition-colors duration-200"
              aria-label="WhatsApp"
            >
