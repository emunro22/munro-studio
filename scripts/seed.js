...
const insightsBySlug = {
  ...
  "enviro-cycle-glasgow": [
    ...
    ["technical", "low", "No schema markup for reviews/business", "50+ Google reviews (5.0★) and a SEPA licence aren't marked up as LocalBusiness/Review schema yet — easy win for rich snippets."],
  ],
  "spotless-detailing": [
  ...
  "renovate-design": [
    ["technical", "critical", "Site renders almost no content server-side", "Homepage HTML is a ~650 byte empty shell (a create-react-app default) — the title tag is just 'Renovate Design' and the meta description is literally the CRA placeholder text, never customized. Search engines see almost nothing here. Recommend rebuilding on the same Next.js/SSR stack as the other client sites, or at minimum fixing title/meta and adding prerendering — right now this site is close to invisible to Google."],
  ],
  "clyde-valley-group": [
    ["upsell", "high", "No address, testimonials, or accreditation badges shown", "For a fuel-systems/motorsport business this is a credibility gap as much as an SEO one (no Gas Safe/OFTEC badges visible) — good upsell conversation around trust content plus local pages."],
