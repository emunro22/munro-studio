...
export const glasgowAreas = [
  ...
  { slug: "east-kilbride", name: "East Kilbride", blurb: "Scotland's largest new town, with a big population and big demand for local trades.", nearby: ["Hamilton", "Rutherglen", "Blantyre"] },
  ...
  { slug: "milngavie", name: "Milngavie", blurb: "Upscale Glasgow suburb, start of the West Highland Way, and a premium trade market.", nearby: ["Bearsden", "Maryhill", "Kirkintilloch"] },
  { slug: "rutherglen", name: "Rutherglen", blurb: "South Lanarkshire town bordering Glasgow, with a busy mix of domestic work.", nearby: ["Cambuslang", "East Kilbride", "Glasgow Southside"] },
  ...
  { slug: "renfrew", name: "Renfrew", blurb: "Renfrewshire town bordering Glasgow Airport, with a busy trade and commercial scene.", nearby: ["Paisley", "Erskine", "Glasgow West"] },
  ...
  { slug: "dumbarton", name: "Dumbarton", blurb: "West Dunbartonshire town on the Clyde, with steady demand for home and trade services.", nearby: ["Clydebank", "Alexandria", "Helensburgh"] },
  ...
  { slug: "newton-mearns", name: "Newton Mearns", blurb: "Affluent East Renfrewshire suburb, with high-spec homes and premium trade and service jobs.", nearby: ["Giffnock", "Clarkston", "Barrhead"] },
  ...
  { slug: "clarkston", name: "Clarkston", blurb: "East Renfrewshire village popular with families, with consistent home-improvement demand.", nearby: ["Giffnock", "Newton Mearns", "Busby"] },
  { slug: "uddingston", name: "Uddingston", blurb: "South Lanarkshire town bordering Glasgow's east end, with a busy domestic trade market.", nearby: ["Bothwell", "Hamilton", "Coatbridge"] },
  ...
  { slug: "kilsyth", name: "Kilsyth", blurb: "North Lanarkshire town at the foot of the Campsies, with a growing commuter population.", nearby: ["Cumbernauld", "Kirkintilloch", "Banton"] },
  { slug: "stepps", name: "Stepps", blurb: "North Lanarkshire commuter village on Glasgow's doorstep, with an affluent homeowner base.", nearby: ["Millerston", "Muirhead", "Bishopbriggs"] },
  { slug: "maryhill", name: "Maryhill", blurb: "Glasgow neighbourhood along the canal: a mix of tenements and new-build, steady trade work.", nearby: ["Maryhill Park", "Anniesland", "Milngavie"] },
  ...
  { slug: "drumchapel", name: "Drumchapel", blurb: "Glasgow suburb on the city's northwest edge, with consistent demand for domestic trades.", nearby: ["Clydebank", "Knightswood", "Bearsden"] },
  { slug: "bridge-of-weir", name: "Bridge of Weir", blurb: "Affluent Renfrewshire village, with high-spec homes and premium trade work in demand.", nearby: ["Kilmacolm", "Houston", "Johnstone"] },
];
...
export const seoPages = {
  ...
  "google-reviews-integration": {
    ...
    faqs: [
      ...
      { q: "How many reviews will show on my site?", a: "I display all your Google reviews on the site with a link to 'See all on Google'. The fresher and more numerous your reviews, the better it looks, and I can show you how to encourage more reviews from happy customers." },
  ...
  "local-seo-glasgow": {
    ...
    faqs: [
      { q: "What's the difference between local SEO and regular SEO?", a: "Regular SEO targets broad keywords, like 'best plumber UK'. Local SEO targets location-based searches, like 'plumber Glasgow' or 'emergency plumber near me'. Local SEO also focuses heavily on Google Maps rankings (Google Business Profile), which drive most calls for local service businesses." },
  ...
  "ai-search-optimization-glasgow": {
    ...
    benefits: [
      ...
      { title: "Answers written the way people ask AI tools", desc: "People ask ChatGPT and Perplexity full questions in plain language, like 'who's a good plumber in Paisley', not keyword fragments. Your FAQ content is written to match that conversational style." },
    ...
    faqs: [
      ...
      { q: "How do I know if my current site is AI-search ready?", a: "Ask ChatGPT or Perplexity a question your ideal customer might ask, such as 'best plumber in Glasgow Southside', and see if your business comes up. If it doesn't, message me and I'll take a look at what's missing." },
    ],
  },
  ...
  "chatgpt-seo-glasgow": {
    ...
    faqs: [
      ...
      { q: "Is this different from normal SEO work?", a: "It builds on the same foundation of a fast, well-structured, keyword-relevant site, but adds a layer focused specifically on clarity and consistency, which is what AI tools weigh most heavily." },
...
trades.forEach((trade) => {
  ...
  seoPages[slug] = {
    ...
    faqs: [
      ...
      { q: "Is this different from normal local SEO?", a: "It builds on the same foundation of a fast, well-structured, keyword-relevant site, but adds a layer focused specifically on clarity and consistency, which is what AI tools weigh most heavily." },
      { q: "Is this included in my monthly plan?", a: "Yes, every site I build follows this approach as standard, at no extra cost on top of your £55/month plan." },
...
seoPages["voice-search-optimization-glasgow"] = {
  ...
  benefits: [
    ...
    { title: "Conversational FAQ content", desc: "Voice queries are longer and more conversational than typed searches, like 'who's a good electrician near me' rather than 'electrician Glasgow'. FAQ content is written to match that natural phrasing." },
  ...
  faqs: [
    { q: "How is voice search different from typing a search?", a: "Voice queries tend to be longer, more conversational, and more likely to have local intent, like 'find a plumber near me' rather than 'plumber Glasgow'. Content and structured data need to match that natural phrasing to be picked up." },
